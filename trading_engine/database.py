...
def close_orphaned_signals_and_positions() -> dict:
    ...
    with _get_session() as session:
        try:
            ...
            sig_keys = {(s.asset, s.strategy_name) for s in all_open_sigs}
            pos_keys = {(p.asset, p.strategy_name) for p in all_pos}
            ...
            sig_keys_after = {(s.asset, s.strategy_name) for s in all_open_sigs_after}
...
def init_db():
    ...
    close_orphaned_signals_and_positions()
