...
- **trend_non_forex (Commodity ETF):** `["CORN", "SOYB", "WEAT", "CANE", "WOOD", "USO", "UNG", "UGA", "SGOL", "SIVR", "CPER", "PPLT", "PALL", "DBB", "SLX"]` — LONG_ONLY, 4:59 PM ET, 3×ATR(100) trailing stop. Uses `stock/latest` endpoint with `type=fund` and batch fetching (8+7 per batch, 2 credits total). AMEX exchange for 14 ETFs, NASDAQ for WOOD.
