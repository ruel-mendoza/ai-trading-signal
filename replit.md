...
- **Production Hardening:**
  ...
  - **Rate Limiting**: slowapi middleware on FastAPI — 60 requests/minute per IP (default), 100 requests/minute application-wide limit, fixed-window strategy.
