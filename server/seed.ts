...
export async function seedDatabase() {
  ...
  const seedSignals = [
    ...
    },
    {
      ...
      status: "closed",
      confidence: 73,
      analysis: "The PHLX Oil Service Sector index (OSX) has found solid support at the 94.00 level, coinciding with the 200-day moving average. The index is forming an ascending triangle pattern with higher lows and resistance near 100.00. Volume on up days has been consistently higher than on down days, suggesting institutional accumulation.\n\nRising crude oil prices and increased drilling activity are providing tailwinds for oil service companies. Equipment utilization rates are climbing, and day rates for offshore rigs are showing improvement. The target at 102.00 represents the upper boundary of the ascending triangle and a prior resistance zone.",
      shortSummary: "OSX oil service index finds support at 200-day MA with ascending triangle pattern.",
    },
    {
      pair: "ETH/USD",
      category: "crypto",
